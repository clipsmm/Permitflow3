...
Route::group(['prefix' => 'e-visa', 'as' => 'e-visa.'], function () {
    ...
    Route::get('settings', 'SettingsController@allSettings')->name('e-visa.settings.all');
    Route::post('settings', 'SettingsController@saveSettings')->name('e-visa.settings.save');
});
