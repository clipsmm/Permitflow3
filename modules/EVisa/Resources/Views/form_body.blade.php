    ...
    <div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group {{error_class($errors, 'country_of_application')}}">
                ...
                {!! Form::select('country_of_application', $country_codes, NULL, ['class' => 'form-control text-black', 'maxlength'=>'160','placeholder' => __('--Select--')]) !!}
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group {{error_class($errors, 'applicant')}}">
                ...
                {!! Form::select('applicant', ['agent' => __('Agent'), 'spouse' => __('Spouse'), 'child' => __('Child'), 'self' => __('Self')], NULL, ['class' => 'form-control text-black', 'maxlength'=>'160']) !!}
        ...
        <div class="col-sm-12">
            <div class="form-group {{error_class($errors, 'travel_reason')}}">
                ...
                {!! Form::textarea('travel_reason', null, ['class' => 'form-control text-black', 'rows' => '3', 'maxlength'=>'160']) !!}
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group {{error_class($errors, 'arrival_by')}}">
                ...
                {!! Form::select('arrival_by', ['air' => __('Air'), 'sea' => __('Sea'), 'road' => __('Road')],  null, ['class' => 'form-control text-black', 'maxlength'=>'160']) !!}
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group {{error_class($errors, 'entry_point')}}">
                ...
                {!! Form::text('entry_point', null, ['class' => 'form-control text-black', 'maxlength'=>'160']) !!}
