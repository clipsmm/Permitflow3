...
@section('form-body')
    <e-visa-application-form inline-template
                             :returning_to_country="{{json_encode($model->returning_to_country)}}"
                             :denied_entry_before="{{json_encode($model->denied_entry_before)}}"
                             :denied_entry_others="{{json_encode($model->denied_entry_before)}}"
                             :convicted_before="{{json_encode($model->convicted_before)}}"
                             :other_recent_visits="{{json_encode($model->other_recent_visits)}}"
                             :recent_visits="{{json_encode($model->recent_visits)}}"
                             :places_to_visit="{{json_encode($model->places_to_visit)}}"
    >
        <div>

            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'country')}}">
                    <label for="">
                        @lang('Country Of Application')
                    </label>
                    {!! Form::select('country_of_application', array_get($lookup_data, 'countries'), 'KE', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'applicant')}}">
                    ...
                    {!! Form::select('applicant', ['agent' => __('Agent'), 'spouse' => __('Spouse'), 'child' => __('Child'), 'self' => __('Self')], 'self', ['class' => 'form-control input-sm']) !!}
                    {!! error_tag($errors, 'country') !!}
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'surname')}}">
                    ...
                    {!! Form::text('surname', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'first_name')}}">
                    ...
                    {!! Form::text('first_name', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'other_names')}}">
                    ...
                    {!! Form::text('other_names', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'gender')}}">
                    ...
                    {!! Form::select('gender', ['M' => __('Male'), 'F' => __('Female'), 'other' => __('Other')], 'M', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'date_of_birth')}}">
                    ...
                    {!! Form::date('date_of_birth', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'country_of_birth')}}">
                    ...
                    {!! Form::date('country_of_birth', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'place_of_birth')}}">
                    ...
                    {!! Form::text('place_of_birth', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'occupation')}}">
                    ...
                    {!! Form::text('occupation', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'fathers_name')}}">
                    ...
                    {!! Form::text('fathers_name', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'mothers_name')}}">
                    ...
                    {!! Form::text('mothers_name', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'spouse_name')}}">
                    ...
                    {!! Form::text('spouse_name', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'nationality')}}">
                    ...
                    {!! Form::select('nationality', array_get($lookup_data, 'countries'), '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'country_of_residence')}}">
                    ...
                    {!! Form::select('country_of_residence', array_get($lookup_data, 'countries'), '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'physical_address')}}">
                    ...
                    {!! Form::text('physical_address', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'email')}}">
                    ...
                    {!! Form::email('email', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'passport_number')}}">
                    ...
                    {!! Form::text('passport_number', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'passport_place_of_issue')}}">
                    ...
                    {!! Form::text('passport_place_of_issue', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'passport_date_of_issue')}}">
                    ...
                    {!! Form::date('passport_date_of_issue', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'passport_date_of_expiry')}}">
                    ...
                    {!! Form::date('date_of_expiry', '', ['class' => 'form-control input-sm']) !!}
                    {!! error_tag($errors, 'date_of_expiry') !!}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'issued_by')}}">
                    <label for="">
                        @lang('Issued By')
                    </label>
                    {!! Form::text('passport_date_of_expiry', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-12">
                <div class="form-group {{error_class($errors, 'travel_reason')}}">
                    ...
                    {!! Form::textarea('travel_reason', '', ['class' => 'form-control input-sm', 'rows' => '3']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'date_of_entry')}}">
                    ...
                    {!! Form::text('date_of_entry', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'date_of_departure')}}">
                    ...
                    {!! Form::text('date_of_departure', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'travel_email')}}">
                    ...
                    {!! Form::text('travel_email', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'travel_phone_number')}}">
                    ...
                    {!! Form::text('travel_phone_number', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'arrival_by')}}">
                    ...
                    {!! Form::select('arrival_by', ['air' => __('Air'), 'sea' => __('Sea'), 'road' => __('Road')],  '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group {{error_class($errors, 'entry_point')}}">
                    ...
                    {!! Form::text('entry_point', '', ['class' => 'form-control input-sm']) !!}
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="place-to-visit" v-for="(place, i) in placesToVisit">
                        <span @click.close="placesToVisit.splice(i, 1)" class="close col-sm-12 text-right">x</span>
                        <div class="col-sm-3">
                            <div class="form-group {{error_class($errors, 'place_type')}}">
                                <label for="">
                                    @lang('Type')
                                </label>
                                {!! Form::select('', ['hotel' => __('Hotel'), 'firm' => __('Firm'), 'relative' => __('Relative/Friend'), 'other' => 'Other'],  '', ['class' => 'form-control input-sm',
                                'v-bind:name' => "'places_to_visit[' + i + ']type'", 'v-model' => 'place.type']) !!}
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{error_class($errors, 'place_name')}}">
                                ...
                                {!! Form::text('', '', ['v-model' => 'place.name', 'class' => 'form-control input-sm', 'v-bind:name' => "'places_to_visit[' + i + ']name'",]) !!}
                        ...
                        <div class="col-sm-5">
                            <div class="form-group {{error_class($errors, 'address_of_place')}}">
                                ...
                                {!! Form::text('', '', ['v-model' => 'place.address', 'class' => 'form-control input-sm', 'v-bind:name' => "'places_to_visit[' + i + ']address'",]) !!}
                                {!! error_tag($errors, 'address_of_place') !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <button @click.prevent="placesToVisit.push({type: '', name: '', address: ''})" class="btn-sm btn btn-primary">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="place-to-visit" v-for="(visit, i)  in otherRecentVisits" key="visit.date">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{error_class($errors, 'other_recent_visits.1.country')}}">
                                ...
                                {!! Form::select('', array_get($lookup_data, 'countries'), '', ['class' => 'form-control input-sm', 'value' => '',
                    ...
                    <div class="col-sm-12">
                        <button @click.prevent="otherRecentVisits.push({country: '', date: '', duration: ''})" class="btn-sm btn btn-primary">
                            <span class="fa fa-plus"></span>
                            @lang('Add')
                        </button>
                    </div>
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <button @click.prevent="recentVisits.push({duration_type: '', date: '', duration: ''})"  class="btn-sm btn btn-primary">
                            <span class="fa fa-plus"></span>
                            @lang('Add')
                        </button>
                    </div>
